      ...
      <div className='float-right h-screen duration-100 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8 w-full'>
        <div className='flex justify-between items-center'>
          <div className='flex gap-3'>
            ...
            <button type='button' className='text-white text-xs rounded p-1 px-2' style={{ background: currentColor }}>5 New</button>
          </div>
          <button type='button' className='text-xl rounded-full p-3 hover:bg-light-gray-500 block' onClick={() => handleClick(!'chat')}><AiOutlineCloseCircle /></button>
        </div>
        <div className='mt-5'>
